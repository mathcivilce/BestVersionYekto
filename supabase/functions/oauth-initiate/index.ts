...
serve(async (req) => {
  ...
  try {
    ...
    authUrl.searchParams.set('redirect_uri', `${Deno.env.get('SUPABASE_URL')}/functions/v1/oauth-callback`);
    ...
    console.log('Generated auth URL with PKCE (without sensitive params)');
